    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
          ...
          <span class="ms-1 font-weight-bold">3awen-Search</span>
        </a>
      </div>
        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Search Furnitures</li>
              </ol>
              <h6 class="font-weight-bolder mb-0">Search Furnitures</h6>
            </nav>
              ...
              <section class="vh-100" style="background-color: rgb(85, 76, 76);">
                        ...
                        <div class="card-body p-md-5">
                          <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                              ...
                              <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Search Furnitures</p>

                              <form method ="GET" class="mx-1 mx-md-4" enctype="multipart/form-data" action={{ url('displayFurnitures') }} >
                                {{csrf_field()}}
                                ...
                                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                    <button type="submit" class="btn btn-primary btn-lg" name ="insert" value="insert" >Search</button>
                                </div>
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                              ...
                              <img src="searchfurnitures.jpg" class="img-fluid" alt="Sample image">
