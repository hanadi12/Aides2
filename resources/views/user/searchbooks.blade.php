        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Search Books</li>
              </ol>
              <h6 class="font-weight-bolder mb-0">Search Books</h6>
            </nav>
              ...
              <section class="vh-100" style="background-color: rgb(196, 121, 161);">
                        ...
                        <div class="card-body p-md-5">
                          <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                              ...
                              <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Search Books</p>

                              <form method ="GET" class="mx-1 mx-md-4" enctype="multipart/form-data" action={{ url('displayBooks') }} >
                                {{csrf_field()}}
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                              ...
                              <img src="searchbooks.png" class="img-fluid" alt="Sample image">
