        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Abb Books</li>
              </ol>
              ...
              <section class="vh-100" style="background-color: rgb(54, 169, 61);">
                        ...
                        <div class="card-body p-md-5">
                          <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                              ...
                              <form method ="POST" class="mx-1 mx-md-4" enctype="multipart/form-data" action={{ url('addbooks') }} >
                                ...
                                <div class="d-flex flex-row align-items-center mb-4">
                                  ...
                                  <div class="form-outline flex-fill mb-0">
                                    <input type="text" id="form3Example3c" class="form-control" name="typebook" />
                                    <label class="form-label" for="form3Example3c">Type Book</label>
                                  </div>
                                </div>
                                ...
                                <div class="d-flex flex-row align-items-center mb-4">
                                    <i class="fas fa-book fa-lg me-3 fa-fw"></i>
                                    <div class="form-outline flex-fill mb-0">
                                      <input class="file-upload-input"  type="file" onchange="readURL(this)" accept="Image/*" name="bookimage" />
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                              ...
                              <img src="addbooks.png" class="img-fluid" alt="Sample image">
