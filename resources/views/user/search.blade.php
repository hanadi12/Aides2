                ...
                <div class="bg-success">
                    <div class="container-fluid bg-trasparent my-4 p-3" style="position: relative;">
                        <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                                ...
                                <div class="col">
                                    <div class="card h-100 shadow-sm"> <img src="uploads/books/logo.png" alt="Imagec" >
                                        <div class="card-body">
                                            <div class="text-center my-4"> <a href="/searchbooks" class="btn btn-warning">SEARCH <br> BOOKS</a> </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="card h-100 shadow-sm"> <img src="uploads/clothes/logo.jpg" alt="Imagec" >
                                        <div class="card-body">
                                            <div class="text-center my-4"> <a href="/searchclothes" class="btn btn-warning">SEARCH <br> CLOTHES</a> </div>
                                ...
                                <div class="col">
                                    <div class="card h-100 shadow-sm"> <img src="uploads/furnitures/logo.jpg" alt="Imagec" >
                                        <div class="card-body">
                                            <div class="text-center my-4"> <a href="/searchfurnitures" class="btn btn-warning">SEARCH FURNITURES</a> </div>
                                ...
                                <div class="col">
                                    <div class="card h-100 shadow-sm"> <img src="uploads/medications/logo.jpg" alt="Imagec" >
                                        <div class="card-body">
                                            <div class="text-center my-4"> <a href="/searchmedications" class="btn btn-warning">SEARCH MEDICATIONS</a> </div>
