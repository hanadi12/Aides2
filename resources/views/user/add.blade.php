                            ...
                            <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
                                    ...
                                    <div class="col">
                                        <div class="card h-100 shadow-sm"> <img src="uploads/books/logo.png" alt="Imagec" >
                                            <div class="card-body">
                                                <div class="text-center my-4"> <a href="/addbooks" class="btn btn-warning">ADD <br> BOOKS</a> </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card h-100 shadow-sm"> <img src="uploads/clothes/logo.jpg" alt="Imagec" >
                                            <div class="card-body">
                                                <div class="text-center my-4"> <a href="/addclothes" class="btn btn-warning">ADD  <br>CLOTHES</a> </div>
                                    ...
                                    <div class="col">
                                        <div class="card h-100 shadow-sm"> <img src="uploads/furnitures/logo.jpg" alt="Imagec" >
                                            <div class="card-body">
                                                <div class="text-center my-4"> <a href="/addfurnitures" class="btn btn-warning">ADD<br> FURNITURES</a> </div>
                                    ...
                                    <div class="col">
                                        <div class="card h-100 shadow-sm"> <img src="uploads/medications/logo.jpg" alt="Imagec" >
                                            <div class="card-body">
                                                <div class="text-center my-4"> <a href="/addmedications" class="btn btn-warning">ADD MEDICATIONS</a> </div>
