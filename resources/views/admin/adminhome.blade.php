	...
	<div class="main-container">
		<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="title pb-20">
				<h2 class="h3 mb-0">3awen Overview</h2>
			</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
                                {{-- <h5>{{ $numB}}</h5> --}}
                                <div class="font-14 text-secondary weight-500">Books</div>
							</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Clothes </div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#ff5b5b"><span class=""></span></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Furnitures</div>
							</div>
							<div class="widget-icon">
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Medications</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#09cc06"><i class="icon-copy fa fa-stethoscope" aria-hidden="true"></i></div>
							</div>
						</div>
					</div>
				</div>
