						...
						<ul class="row">
							<li class="col-lg-4 col-md-6 col-sm-12">
								<div class="product-box">
									<div class="producct-img"><img src="{{ asset('uploads/clothes/' . $books->clothesimage ) }}" alt=""></div>
									<div class="product-caption">
										<h4><a href="#">{{ $books->nameuser }}</a></h4>
										<div class="price">
											<ins>{{ $books->typeclothes }}</ins>
										</div>
										<a href="{{ url('/deleteclothes',$books->id) }}"><i class="icon-copy dw dw-delete-3"></i></a>
									</div>
								</div>
							</li>
